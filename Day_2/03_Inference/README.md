...
During the exercises, focus discussion on experimental decision-making. A useful check is to ask: would this prediction, uncertainty estimate, or acquisition score change which variants we test next?
